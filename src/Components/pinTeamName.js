...
class PinTeamName extends Component {
    constructor(props) {
        super(props);
        this.state = {
            teamName: '',
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (Actions.currentScene === 'pinteamname') {
            return true;
        }
        else {
            return false;
    ...
    onSubmit() {
        ...
        if (TeamName.teamMembers[0] === undefined || !(/\S/.test(TeamName.teamMembers[0]))) {
            alert('Please Type Atleast 1 Team Member Name')
                                ...
                                this.state.gotTeamName ?
                                    ...
                                    <View>
                                        ...
                                        <nb.Item rounded style={{ width: '60%', alignSelf: 'center', marginVertical: 10 }} >
                                            <nb.Input onChangeText={teamName => this.setState({ teamName })} style={{ textAlign: 'center' }} placeholder='Team Name' autoFocus placeholderTextColor='#909090' />
                                        </nb.Item>
...
export default connect(mapStateToProps, { addTeamName, clearEveryThing })(PinTeamName)
