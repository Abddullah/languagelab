...
import { SignUpAction, loginFailed } from '../../Actions/AuthAction';
            ...
            <Container style={{ backgroundColor: '#f7f9ff' }}>
                ...
                <View style={styl.header}>
                    <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', paddingLeft: 15 }}>
                        ...
                        <Text style={{ fontSize: 15, color: 'white', paddingLeft: 10 }} >CREATE AN ACCOUNT</Text>
                        {/* </TouchableOpacity> */}
                    </View>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Button style={{ alignSelf: 'flex-end' }} transparent warning onPress={() => Actions.login()}>
                            <Text style={{ fontSize: 13, color: 'yellow', fontWeight: 'bold' }}>SIGN IN</Text>
                        </Button>
                    </View>
                </View>
                <ScrollView>
